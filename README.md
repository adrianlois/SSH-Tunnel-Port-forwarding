...
Si el servidor remoto SSH al que nos conectamos para realizar el pivoting (mi.servidorssh.com) está expuesto por otro puerto que no sea el 22 por defecto, podemos especificarlo con el parámetro `-p <puerto-servidor-ssh>`.
